    ...
    <main className="w-full">
      ...
      <section className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/35 z-10">
          <h1 className={`text-[rgb(186,168,91)] text-6xl text-left ${dancingScript.className}`}>
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            ...
            <div className="flex-1">
              <div className="flex flex-col gap-4 max-h-[350px] overflow-y-auto pr-2 pb-4">
                <article className="bg-zinc-50 p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col sm:flex-row sm:items-center gap-4 hover:shadow-md transition-shadow cursor-pointer">
